...
//Importando Iconos de Material-UI
    ...
    <div className="main">
      ...
      <div className="todayMain">
        <section className="btns">
          ...
          <button className="btnGps"><MyLocationIcon/></button>
        </section>

        <div className="contImgC">
        <img
          src={imageI}
          alt={props.list[0].weather[0].description}
          title={props.list[0].weather[0].description}
        ></img>
      </div>

        <p><span className="tempToday">{parseInt(props.list[0].main.temp_max)}</span><span className="tempTodayU">{props.uni}</span></p>
        <p className="descToday"> {props.city.name}</p>
        ...
        <p className="locationActive">
          <RoomIcon/><span className="iconLoc">{props.city.name} {props.city.country}</span></p>
      </div>
      </> }
      </div>
        ...
        <section className="detailAdi">
          <article className="det">
            ...
            <div className="barPor">
              <p className="contWind">
                <div className="IconNear">
                  <NearMeIcon/>
                </div>
                <span>WSW</span></p>
            </div>
      ...
      <footer><p className="footer">created by Jose C Tucci Peña - Creaciones Index</p></footer>
